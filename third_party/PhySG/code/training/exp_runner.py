...
if __name__ == '__main__':
    ...
    parser.add_argument('--freeze_geometry', default=False, action="store_true",
                        help='')
    parser.add_argument('--illumination_idx', default='013', help='index of illumination to use')
    parser.add_argument('--output_img_size',nargs='+', type=int, default=[800, 1200], help='output image size')
    ...
    trainrunner = IDRTrainRunner(conf=opt.conf,
                                 ...
                                 expname=opt.expname,
                                 gpu_index=gpu,
                                 illumination_idx=opt.illumination_idx,
                                 output_img_size=opt.output_img_size,
