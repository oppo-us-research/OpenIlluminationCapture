...
class IDRTrainRunner():
    def __init__(self,**kwargs):
        ...
        self.illumination_idx = kwargs['illumination_idx']
        self.output_img_size = kwargs['output_img_size']
        ...
        self.train_dataset = utils.get_class(self.conf.get_string('train.dataset_class'))(kwargs['gamma'],
                                                                                          kwargs['data_split_dir'],kwargs['illumination_idx'],
                                                                                          kwargs['output_img_size'], self.train_cameras)
        ...
        self.plot_dataset = utils.get_class(self.conf.get_string('train.dataset_class'))(kwargs['gamma'],
                                            ...
                                            kwargs['illumination_idx'],
                                            kwargs['output_img_size'],
                                            self.train_cameras)
    ...
    def plot_to_disk(self):
        ...
        plt.plot(self.write_idr, self.writer,self.train_dataset.gamma, self.model,
                 indices,
                 model_outputs,
                 model_input['pose'],
                 ground_truth['rgb'],
