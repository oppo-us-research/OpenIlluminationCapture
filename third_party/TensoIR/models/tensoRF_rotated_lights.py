...
class TensorVMSplit(TensorBase):
    ...
    def get_optparam_groups(self, lr_init_spatialxyz = 0.02, lr_init_network = 0.001):
        ...
        if (self.normals_kind == "pure_predicted" or self.normals_kind == "derived_plus_predicted" or self.normals_kind == "residue_prediction") \
    ...
    def compute_bothfeature(self, xyz_sampled, light_idx):
        ...
        static_index = torch.arange(self.light_num).to(xyz_sampled.device, dtype=torch.int32) # [rotation_num, ]
