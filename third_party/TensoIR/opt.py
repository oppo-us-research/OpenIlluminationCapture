...
def config_parser(cmd=None):
    ...
    parser.add_argument('--far', type=float, default=12.0)
    parser.add_argument('--imgw', type=int, default=1200)
    parser.add_argument('--imgh', type=int, default=900)
    parser.add_argument('--bbox_scale', type=float, default=1.0)
    parser.add_argument('--sg_intensity_scale', type=float, default=1.0)
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        ...
                        'tensoIR_simple','tensoIR_relighting_test', 'tensoIR_material_editing_test', 
                        'tensoIR_lightstage', 'tensoIR_lightstage_multi_light'])
    ...
    parser.add_argument("--log_every", type=int, default=500,
                        help='frequency of log the results to tensorboard')
    ...
    parser.add_argument("--light_sample_train", type=str, default='stratified_sample')

    parser.add_argument("--light_kind", type=str, default='sg', help='light kind, pixel or spherical gaussian', choices=['pixel', 'sg', 'sg_fixed'])
    ...
    parser.add_argument("--light_positions_train", type=str, action="append")
    parser.add_argument("--light_positions_test", type=str, action="append")
    ...
    parser.add_argument("--geo_buffer_path", type=str, default='../debug')
    ...
    parser.add_argument("--normals_diff_weight", type=float, default=0.0002, help="weight for normals difference loss")

    parser.add_argument("--normals_orientation_weight", type=float, default=0.001, help="weight for normals direction loss, introduced in ref-nerf as Ro loss")
    ...
    parser.add_argument("--normals_kind", type=str, default="pure_derived", help="ways to get normals",
                        choices=["pure_derived", "pure_predicted", "derived_plus_predicted", "gt_normals", "residue_prediction"])
