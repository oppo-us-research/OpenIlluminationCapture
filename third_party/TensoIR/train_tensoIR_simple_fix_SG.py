...
renderer = Render_relight_unknown_rotated_lights
...
def render_test(args):
    ...
    test_dataset = dataset(
                            ...
                            light_positions_train=args.light_positions_train,
                            light_positions_test=args.light_positions_test,
    ...
    if args.ckpt is None:
        print('+++++++++++++ Load checkpoint exp folder +++++++++++++')
    ...
    # Load SG gt if use 'sg_fixed' as light_kind
    if args.light_kind == 'sg_fixed':
        tensoIR.loadSGs(test_dataset.lgtSGs_list, args.sg_intensity_scale)
...
def reconstruction(args):
    ...
    if args.ckpt is not None:
        ...
        tensoIR = eval(args.model_name)(aabb, 
                                        ...
                                        light_name_list = args.light_positions_train
                                        )


    # Load SG gt if use 'sg_fixed' as light_kind
    if args.light_kind == 'sg_fixed':
        tensoIR.loadSGs(train_dataset.lgtSGs_list, args.sg_intensity_scale)
